...
public class Consultar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tabela1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Nome", "Descrição", "Val. compra", "Val. venda", "Categoria"
            }
        ) {
    ...
    private void AlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AlterarActionPerformed
        ...
        int linha = Consultar.tabela1.getSelectedRow();
         ...
         if (linha >= 0) {
            ...
            Integer id = (Integer) Consultar.tabela1.getValueAt(linha, 0);

            try {
                //jogando os dados do cliente nas caixas de texto da tela de edição
                ServicoProduto.obterProduto(id);
            }  catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Falha ao obter lista de Produtos!!!");
             }    
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
         ...
         if (Consultar.tabela1.getSelectedRow() >= 0) {
            //pegando o nome, que está na primeira coluna da tabela
            String nome = tabela1.getValueAt(linha, 0).toString();

            //criando uma caixa de confirmação, para ter certeza de que quer excluir tal cliente
